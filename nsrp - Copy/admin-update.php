...
if(isset($id))
{
	$result=mysqli_query($con,"SELECT first_name,last_name,mail from jl WHERE id='$sid'");
...
if(isset($_POST['submit']))
{
	...
	//echo $firstname."</br>".$lastname."</br>".$email."</br>".$date;
	...
	{
		mysqli_query($con,"UPDATE jl SET 
		first_name='$firstname',last_name='$lastname',mail='$email' WHERE id='$sid'");
...
-->
  ...
  <body class="tm-gray-bg">
	...
	<section class="container tm-home-section-1" id="more">
		...
		<!--<div class='login-form col-md-4 offset-md-4'>-->
		<div class='jumbotron'>
		<h3 align='center'>Update Journal Details</h3></br>
			<!--<?php echo $msg9; ?></br>-->
			
			<form method='post' enctype="multipart/form-data">
			<div class="form-group">
				<label>Journal Name :</label>
				<input type='text' name='fname' placeholder="Your First Name" class='form-control' value='<?php echo $name; ?>'>
				<?php echo $msg; ?>
			</div>
			<div class="form-group">
