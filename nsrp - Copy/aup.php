	  			...
	  			<div class="col-lg-6 col-md-8 col-sm-9">
	  				...
	  				<nav class="tm-nav">
						<ul>
							...
							<li><a href="ain.php">Insert</a></li>
							<li><a href="aup.php" class="active">Update</a></li>
						</ul>
					</nav>		
	  			</div>				
  			</div>
...
//if(isset($name))
	...
	//echo "<a href='admin.php><button class='btn btn-primary' styles='float:right;margin-left:150px;'>Logout</button></a>";
	echo "</br><br>";
	...
	while($retrive=mysqli_fetch_array($result))
	{
		...
		echo "<th>$lname</th>";
		echo "<th>$email</th>";
		echo "<th><a href='delete_admin.php?del=$id'><button class='btn btn-danger'>Delete</button></th>";
		echo "<th><a href='admin-update.php?user=$id'><button class='btn btn-success'>Upadate</button></th>";
	    echo "</tr>";
	}
	echo "</table>";
//}
